...
public class Main {
	...
	public static void main(String[] args) {
		// TODO decide on the number of plusses (maybe ask the user?)
		
		// TODO call a method that prints the plusses triangle
	...
	// TODO maybe we can even combine the regular and reverse triangle?
